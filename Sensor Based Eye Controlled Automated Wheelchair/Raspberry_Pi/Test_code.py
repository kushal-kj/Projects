...
r=requests.post('  "Enter  your cloud storage link"  =3',data='')
time.sleep(.2)
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            if w>10 and h>10:
                ...
                #print(count)
                if count4>4  and np.argmax(pred)==3:
                    count4=0
                    if prev==0 and f==0 :
                        prev=1
                        print('Wheel chair Started Forward1')
                        r=requests.post('	"Enter  your cloud storage link"	=1',data='')
                        time.sleep(.2)
                ...
                elif np.argmax(pred)==0 and count1>4 and b==0:
                    count1=0
                    ...
                    r=requests.post('	"Enter  your cloud storage link"	=2',data='')
                    time.sleep(.2)
                    ...
                    rt=0
                    lf=0
                elif np.argmax(pred)==1 and count2>4 and lf==0:
                    count2=0
                    print('Wheel chair Stoped')
                    #r=requests.post('	"Enter  your cloud storage link"	=3',data='')
                    #time.sleep(.3)
                    ...
                    r=requests.post('	"Enter  your cloud storage link"	=5',data='')
                    time.sleep(.2)
                    ...
                    rt=0
                    lf=1
                elif np.argmax(pred)==2 and count3>4 and rt==0:
                    count3=0
                    print('Wheel chair Stoped')
                    #r=requests.post('	"Enter  your cloud storage link"	=3',data='')
                    #time.sleep(.3)
                    ...
                    r=requests.post('	"Enter  your cloud storage link"	=4',data='')
                    time.sleep(.2)
                    ...
                    rt=1
                    lf=0
#                 elif np.argmax(pred)==5 and count5>4 and f==0:
#                     count3=0
#                     print('Wheel chair Stoped')
#                     #r=requests.post('	"Enter  your cloud storage link"	=3',data='')
#                     #time.sleep(.3)
